                ...
                <tbody>
                    ...
                    <tr>
                        <td style="padding: 20px 30px; text-align: center;">
                            <a href="<?php echo $url; ?>" style="background-color: #2f55d4; color: #ffffff; padding: 15px 30px; text-decoration: none; border-radius: 5px; font-weight: 600; font-size: 16px; display: inline-block;">
                    ...
                    <tr>
                        <td style="padding: 20px 30px; color: #8492a6; font-size: 13px; line-height: 1.5;">
                            ...
                            <a href="<?php echo $url; ?>" style="color: #2f55d4; word-break: break-all;"><?php echo $url; ?></a>
                        </td>
                    </tr>
